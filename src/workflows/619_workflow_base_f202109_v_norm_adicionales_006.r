...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1301_FE_intrames_manual_v_norm_adicionales_001.r" # <<<<<<<------->>>>>>> acá cambio archivo con variables
...
wf_septiembre <- function( pnombrewf )
{
  ...
  fm <- FM_final_models_lightgbm( c(ht, ts9), ranks=c(1), qsemillas=30 )
  SC_scoring( c(fm, ts9) )
  KA_evaluate_kaggle()
