...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  #param_local$final_train$training <- c(201903,201904,201907,201908,201911,202011,202012,202103,202104) 
  param_local$final_train <- c(202107, 202106, 202105, 202104, 202103, 202102, 202101, 
                               ...
                               201912, 201911, 201909, 201908, 201907, 201906, 201904, 201903
  )
  
  
  # param_local$train$training <- c(202105, 202104, 202103, 202102, 202101,
  #   202012, 202011, 202010, 202009)
  # param_local$train$training <- c(201901,201902,201905,201906,201909,201910,202001,202002,202101,202102)
  # param_local$train$validation <- c(202106,202104)
  # param_local$train$testing <- c(202107,202105)
  param_local$train$training <- c(202105, 202104, 202103, 202102, 202101, 
                                  202012, 202011, 202010, 202009, 202008, 202007, 202005, 202004, 202003, 202002, 202001,
                                  201912, 201911, 201909, 201908, 201907, 201906, 201904, 201903, 201902, 201901 
  )
