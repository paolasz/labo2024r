...
FEintra_manual_base <- function( pinputexps )
{
  ...
  # este tiene lass adicionales y esas mismas que se pudieron normalizar
  param_local$meta$script <- "/src/wf-etapas/1301_FE_intrames_manual_v_norm_adicionales_003.r" # <<<<<<<------->>>>>>> acá cambio archivo con variables
