...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train <- c(202107, 202106, 202105, 202104, 202103, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901)
  

  # param_local$train$training <- c(202105, 202104, 202103, 202102, 202101,
  #   202012, 202011, 202010, 202009)
  param_local$train$training <- c(202105, 202104, 202103, 202102, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901)
