...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1301_FE_intrames_manual_B3.r"
...
DR_drifting_base <- function( pinputexps, metodo)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1401_DR_corregir_drifting_009.r"
...
FErf_attributes_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$lgb_param <- list(
    ...
    num_iterations = 55, # 20,
    num_leaves  = 45, #16,
    min_data_in_leaf = 150, #1000,
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$undersampling <- 0.7
  param_local$final_train$clase_minoritaria <- c( "BAJA+1", "BAJA+2")
  #param_local$final_train$training <- c(202107, 202106, 202105, 202104, 202103, 202102,
  #  202101, 202012, 202011)
  param_local$final_train$training <- c(201904,201905,201906,202004,202005,202009,202010,202101,202102,202105,202106,202107) 

  # param_local$train$training <- c(202105, 202104, 202103, 202102, 202101,
  #   202012, 202011, 202010, 202009)
  param_local$train$training <- c(201901,201902,201903,202002,202003,202007,202008,202011,202012,202103,202104,202105)
  param_local$train$validation <- c(201906,202106)
  param_local$train$testing <- c(201907,202107)
...
wf_septiembre <- function( pnombrewf )
{
  ...
  #FEintra_manual_base()
  DR_drifting_base(metodo="dol_blue")
  FEhist_base()
