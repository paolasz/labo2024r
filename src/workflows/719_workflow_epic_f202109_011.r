...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202004,202005,202009,202010,202101,202102,202105,202106,202107) 

  # param_local$train$training <- c(202105, 202104, 202103, 202102, 202101,
  #   202012, 202011, 202010, 202009)
  param_local$train$training <- c(202002,202003,202007,202008,202011,202012,202103,202104,202105)
