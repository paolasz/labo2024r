...
PARAM$finalmodel$learning_rate <-0.0832704453571308
PARAM$finalmodel$feature_fraction <- 0.505012044912786
PARAM$finalmodel$min_data_in_leaf <- 1277
PARAM$finalmodel$num_leaves <- 729
