...
PARAM$finalmodel$num_iterations <- 540
PARAM$finalmodel$learning_rate <-0.022
PARAM$finalmodel$feature_fraction <- 0.44
PARAM$finalmodel$min_data_in_leaf <- 1221
PARAM$finalmodel$num_leaves <- 383
