...
PARAM$finalmodel$num_iterations <- 419
PARAM$finalmodel$learning_rate <-0.120602169
PARAM$finalmodel$feature_fraction <- 0.901585918
PARAM$finalmodel$min_data_in_leaf <- 982
PARAM$finalmodel$num_leaves <- 215
...
PARAM$finalmodel$lambda_l2 <- 510
