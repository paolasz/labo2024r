...
PARAM$finalmodel$num_iterations <- 266
PARAM$finalmodel$learning_rate <-0.0831989382935392
PARAM$finalmodel$feature_fraction <- 0.610790187940737
PARAM$finalmodel$min_data_in_leaf <- 1096
PARAM$finalmodel$num_leaves <- 344
