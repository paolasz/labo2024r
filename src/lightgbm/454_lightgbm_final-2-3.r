...
PARAM$finalmodel$num_iterations <- 166
PARAM$finalmodel$learning_rate <-0.105917144158267
PARAM$finalmodel$feature_fraction <- 0.294343941022303
PARAM$finalmodel$min_data_in_leaf <- 1029
PARAM$finalmodel$num_leaves <- 785
...
PARAM$finalmodel$lambda_l2 <- 160
...
for (envios in cortes) {
  ...
  fwrite(tb_entrega[, list(numero_de_cliente, Predicted)],
    file = paste0(PARAM$experimento, "_003_", envios, ".csv"),
    sep = ","
  )
}
