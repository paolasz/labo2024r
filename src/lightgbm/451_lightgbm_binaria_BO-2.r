...
hs <- makeParamSet(
 ...
 ,makeIntegerParam("lambda_l1", lower = 0L, upper = 600L),
  makeIntegerParam("lambda_l2", lower = 0L, upper = 600L)
...
EstimarGanancia_lightgbm <- function(x) {
  ...
  param_basicos <- list(
    ...
    #lambda_l1 = 1, #0.0, # por ahora, lo dejo fijo
    #lambda_l2 = 160, #0.0, # por ahora, lo dejo fijo
